...
var trueFaveNum = 24==faveNum; // CODE HERE
...
function greeter(name, number){
  var sentence = "Hi! I am " + name + " and I am " + number + " years old";
  return sentence;
};// CODE HERE
